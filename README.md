...
- 🔭 Working on a project tracking **Bird Migration using Python 3** 🐦  
- 👯 Open to collaborate on **Web Development & Data Visualization** projects  
- 🤝 Looking for help with **scaling real-time dashboards & optimizing data pipelines**  
- 💬 Ask me about **React, Vue, and GSAP animations**  
- ⚡ Fun fact: I once went **skydiving from 23,000 feet** — coding feels less scary after that 😄  
